...
private:
    ...
    std::vector<std::string> Passes{ "Position Pass", "Normal Pass", "Albedo Pass","SSAO Pass", "RT Shadow Pass","Light Pass","SSGI Pass","RT Reflections","ReSTIR DI", "Motion Vector",  "DDGI Pass","Combined Pass" };
