...
if (WIN32)
  ...
  include_directories(${NvPerfUtility_IMPORTS_GLFW_DIR}/include)
endif()
...
set(OUTPUT_PATH ${CMAKE_CURRENT_BINARY_DIR} CACHE PATH "Directory where outputs will be stored")
...
if(NOT EXISTS ${CMAKE_BINARY_DIR}/downloaded_resources)
  file(MAKE_DIRECTORY ${CMAKE_BINARY_DIR}/downloaded_resources)
endif()
...
macro(_add_package_ZLIB)
  if(WIN32 AND EXISTS ${BASE_DIRECTORY}/shared_external/zlib)
